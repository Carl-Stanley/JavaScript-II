...
for (var i in runners) {
  ...
  namePlaceHolder = runners[i];

  lastname = namePlaceHolder["last_name"];

  firstname = namePlaceHolder["last_name"];
...
for (var i in runners) {
  ...
  allCaps.push(firstname.toUpperCase() + " " + lastname);
...
for (var i in runners) {
  ...
  if(namePlaceHolder["shirt_size"] = "L") {
...
for (var i in runners) {
  ...
  namePlaceHolder["donation"]
  
  total = total + namePlaceHolder["donation"];
